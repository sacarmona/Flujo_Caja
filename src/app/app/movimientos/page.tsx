...
import { cancelMovementAction, createMovementAction, getMovementDefaults, updateMovementAction } from "@/app/app/movimientos/actions";
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="text-right">
                  <p className="text-lg font-semibold text-adentu-ink">
                    {movement.currency === "CLP" ? formatCurrency(Number(movement.amount)) : `${movement.amount.toString()} ${movement.currency}`}
                  </p>
